...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Dumont Calendar";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "noreply@getdumont.ai";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Dumont";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Dumont Calendar";
